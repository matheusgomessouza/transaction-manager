...
import ManageTransactionsModal from '../../transactions/components/ManageTransactionsModal';
...
export default function UsersList() {
  ...
  return (
    <>
      <div className="flex flex-col gap-8 w-full max-w-7xl mx-auto">
        ...
        <header className="flex items-center justify-between w-full">
          ...
          <button
            ...
            className="bg-accent-green text-page px-3 py-1.5 rounded text-base font-medium hover:bg-opacity-90 transition-opacity"
          >
            + Manage Transactions
          </button>
        </header>
      ...
      <ManageTransactionsModal isOpen={modalOpen} onClose={() => setModalOpen(false)} />
    </>
  );
}
